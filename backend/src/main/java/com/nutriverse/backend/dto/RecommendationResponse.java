...
public class RecommendationResponse {
    ...
    public RecommendationResponse(
        ...
        this.explanationMethod =
                explanationMethod;

        this.interpretedDiet =
                interpretedDiet;

        this.interpretedGoal =
                interpretedGoal;
    ...
    public void setExplanationMethod(
            String explanationMethod
    ) {
        this.explanationMethod =
                explanationMethod;
    ...
    public void setInterpretedDiet(
            String interpretedDiet
    ) {
        this.interpretedDiet =
                interpretedDiet;
    ...
    public void setInterpretedGoal(
            String interpretedGoal
    ) {
        this.interpretedGoal =
                interpretedGoal;
